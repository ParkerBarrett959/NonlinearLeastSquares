 ...
 *
 * Problem statement: Example 3 contained in this executable is a test of the
...
#include "functors/Example3Functor.h"
#include <iostream>
#include <random>

int main() {
  // Create a functor for the example 3 problem
  std::shared_ptr<ModelFunctor> modelPtr = std::make_shared<Example3Functor>();

  // Define the truth model parameters
  Eigen::VectorXd ATruth(4);
  ATruth << 6.0, 20.0, 1.0, 5.0;
  ...
  SolverOpts optsGD = {.max_iter = 50000,
                       ...
                       .lambda0 = 1.0,
                       .factor = 2.0};
  SolverOpts optsGN = {.max_iter = 50000,
                       .convergence_criterion = 1.0e-9,
                       .print_steps = false,
                       .alpha = 1.0,
                       .lambda0 = 1.0,
                       .factor = 2.0};
  SolverOpts optsLM = {.max_iter = 50000,
